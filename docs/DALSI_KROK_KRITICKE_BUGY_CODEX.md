...
> **Priorita: pred M8.3/M8.4.** Nálezy 1+2 sa kombinujú do garantovaného
> soft-locku hry v druhom ťahu bežnej hry. Toto je inštrukcia pre
> implementáciu, nie hotový kód — kódiaci agent má tento súbor prevziať.
