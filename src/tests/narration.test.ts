...
import { ALL_TEMPLATES, validateTemplateCounts, defaultTemplateLoader } from '../battle/narration/templates/loader';
  ...
  describe('Anti-repetition', () => {
    it('should not repeat templates within window', () => {
      ...
      for (let i = 0; i < windowSize + 5; i++) {
        ...
        // Track template IDs (we can't directly access them, but we can check sentences)
        // For this test, we'll just verify that we get different sentences
      }
