...
describe('Battle Formulas', () => {
  ...
  describe('evaluateDecisionPhase', () => {
    ...
    it('should return defender as winner when decision power is equal', () => {
      ...
      // Sanity check: evaluateDecisionPhase always returns a valid winner.
    ...
    it('determineDecisionWinner: defender wins on exact power equality', () => {
      expect(determineDecisionWinner(100, 100)).toBe('defender');
    });

    it('determineDecisionWinner: higher power wins', () => {
      expect(determineDecisionWinner(101, 100)).toBe('attacker');
      expect(determineDecisionWinner(100, 101)).toBe('defender');
    });
  });
