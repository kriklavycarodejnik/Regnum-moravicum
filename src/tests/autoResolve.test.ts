...
describe('Auto-resolve', () => {
  ...
  describe('shouldAutoResolve', () => {
    ...
    it('should return true exactly at ratio 2.0', () => {
      // Create armies with exactly 2.0 ratio. Both use a neutral factionId
      // (neither 'hungarian' nor 'moravian') so no faction trait bonus
      // (e.g. Hungarian cavalry on field) breaks the clean size ratio.
    ...
    it('should return true exactly at ratio 0.5', () => {
      // Create armies with exactly 0.5 ratio (see note above about neutral factionId).
