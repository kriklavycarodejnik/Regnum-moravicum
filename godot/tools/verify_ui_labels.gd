...
func _ready() -> void:
	...
	var fails = [0]
	var raw_tokens: Array = ["moravia_levy_1", "moravia_feudal_1", "madari_horde_1", "unknown_xyz", "unknown_fac_xyz", "unknown_army_xyz", "raw_faction_db_key", "raw_province_db_key"]
	...
	if fails[0] == 0:
		...
		print("KONTROLA ZLYHALA: %d chýb!" % fails[0])
	print("==========================================")
